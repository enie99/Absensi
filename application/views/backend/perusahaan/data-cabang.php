        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    <div class="span12">
                        <form name="filterFrm" action="<?php echo base_url('mastercms/perusahaan/cari');?>" method="get">
                            <div class="span2">
                                <div class="controls">
                            ...
                            <div class="span4" style="margin-left: 5px">
                                <div class="controls">
                                    <p>
                                        <button type="submit" class="btn btn-primary"><a href="<?php echo base_url('mastercms/perusahaan/cari'); ?>"><i class="fa fa-search"></i></a> Cari Data</button>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td data-title="Aksi" align="center">
                                                    ...
                                                    <!-- <a href="<?php echo base_url('mastercms/perusahaan/hapus'); ?>" title="Hapus" onClick="return confirm('Anda yakin ingin menghapus data ini?')"><i class="fa fa-trash-o"></i></a> &nbsp; -->
